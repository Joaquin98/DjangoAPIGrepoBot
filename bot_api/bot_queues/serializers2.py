...
class AutoCultureTownSettingsInputSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def save(self, **kwargs):
        ...
        town = PlayerInfo.objects.get(
            player_id=self._validated_data['player_id'], world_id=self._validated_data['world_id']).towns.get(town_id=self._validated_data['town_id'])
...
class BuildingOrderSerializer(Serializer.HyperlinkedModelSerializer):
