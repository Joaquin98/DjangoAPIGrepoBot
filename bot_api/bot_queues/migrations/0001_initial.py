# Generated by Django 4.0.8 on 2023-02-07 15:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AssistantSettings', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bot_queues.assistantsettings')),
                ('AutoBuildSettings', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bot_queues.autobuildsettings')),
                ('AutoCultureSettings', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bot_queues.autoculturesettings')),
                ('AutoFarmSettings', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bot_queues.autofarmsettings')),
                ('City', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bot_queues.city')),
            ],
        ),
        migrations.CreateModel(
            name='BuildingOrder',
        ...
        migrations.AddField(
            ...
            name='City',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bot_queues.city'),
        ),
    ]
